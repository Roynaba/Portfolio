            ...
            <div class="container">
                <div class="main__header d-flex justify-content-between align-items-center">
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index">
                            <img class="main__logo--img logo_light" src="assets\img\nabajit\logo.png" alt="logo-img">
                            <img class="main__logo--img logo_dark" src="assets\img\nabajit\logo.png" alt="logo-img">
                        </a></h1>
                    </div>
